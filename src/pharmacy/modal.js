    ...
    >
      ...
      {medicines.map((med, i) => (
        ...
        <Col span={12}>
          ...
          <div style={{ fontWeight: 700, marginBottom: 5, fontSize: 16}}>Prescription Detail</div>
<Row gutter={2} style={{ marginBottom: 6 }}>
  <Col span={12}>
    <div style={{ marginBottom: 4 }}>
      <div style={{ fontSize: 12, fontWeight: 500, marginBottom: 0 }}>
        Medicine Name
      </div>
      <Input placeholder="Medicine Name" value="" disabled style={{  background: "#F8F8F8" }}  />
    </div>
  </Col>
  ...
  <Col span={6}>
    <div style={{ marginBottom: 4 }}>
      ...
      <Input placeholder="Form" value="" disabled style={{  background: "#F8F8F8" }} />
    </div>
  </Col>
...
<Row gutter={2} style={{ marginBottom: 6 }}>
  ...
  <Col span={5}>
    <div style={{ marginBottom: 4 }}>
      ...
      <Input placeholder="Frequency" value="" 
  ...
  <Col span={4}>
    <div style={{ marginBottom: 4 }}>
      ...
      <Input placeholder="Order for Days" value="" 
      disabled style={{  background: "#F8F8F8" }}
      />
    </div>
  </Col>
  ...
  <Col span={4}>
    <div style={{ marginBottom: 4 }}>
      ...
      <Input placeholder="Order QTY" value="" 
      disabled style={{  background: "#F8F8F8" }}
      />
    </div>
  </Col>
...
<Col span={24}>
  <div style={{ display: "flex", alignItems: "center", marginBottom: 4 }}>
    ...
    />
          ...
          <div style={{ fontWeight: "bold", margin: "10px 0 5px" }}>Dispensing Detail</div>
  ...
  >
    ...
    <div style={{ flex: 1 }}>
      ...
      <Input placeholder="Total Price" />
          ...
          <div style={{ fontWeight: "bold", margin: "10px 0 5px" }}>Only for Narcotics</div>
    ...
    <Row gutter={12}>
      ...
      <Col>
        <div>
          ...
          <Input placeholder="Prescribed Quantity" style={{ width: 180 }} />
        </div>
      </Col>
    ...
    <div style={{ textAlign: "right", marginTop: 20 }}>
      ...
      <Button onClick={() => setSkipOpen(true)}>Skip</Button>
        ...
        <Col span={7} style={{marginTop: 10}}>
          ...
          <div style={{ fontWeight: "bold", margin: "20px 0 5px 0" }}>Lab Result</div>
          <Table
            columns={labColumns}
            dataSource={labData}
            size="small"
